...
export const animatedTestimonialsDemo: Array<Testimonial> = [
  {
    content:
  ...
  {
    content: "It's kind of like reading a beautifully designed interactive Medium article.",
    image: "",
  },
  {
    content:
  ...
  {
    content: "The bar he sets is ridiculous. Every company I know wants to work with him.",
    image: "",
  },
]
